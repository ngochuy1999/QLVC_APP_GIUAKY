            ...
            public void onClick(View v) {
                ...
                try {
                    if(flagValid)
                    {
                        ...
                        DBhelper= new DBHelper(SuaVatTuActivity.this,"qlvc.sqlite",null,1);
                        ...
                        Toast.makeText(SuaVatTuActivity.this, "sửa vật tư thành công!", Toast.LENGTH_LONG).show();
                        //thêm xong thì về lại danh sách
                        Intent intent = new Intent(SuaVatTuActivity.this, DSVatTuActivity.class);
                        startActivity(intent);
                    }
                }
                catch (Exception e)
                {
                    Toast.makeText(SuaVatTuActivity.this, "không thành công!", Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
            }
        });
